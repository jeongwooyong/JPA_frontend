...
export async function loadProducts({ request }: LoaderFunctionArgs) {
    ...
    const res = await
        axios.get(`http://localhost:8080/api/products/list?${queryStr}`)
    return res.data
}
...
const ListPage = () => {
    ...
    return (
        <div className="w-full mt-4 border border-solid border-neutral-300 shadow-md"><div className="text-2xl m-4 font-extrabold">
            Products List Page
        </div>
